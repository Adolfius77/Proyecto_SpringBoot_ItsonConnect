...
import javax.swing.JPasswordField; // ¡Importante! Cambiado de JTextField

/**
 * Un JPasswordField personalizado con esquinas redondeadas y un borde.
 * @author adoil (¡y Asistente de programación!)
 */
public class PasswordFieldRedondo extends JPasswordField { // ¡Cambiado!

    private int radius;

    public PasswordFieldRedondo() {
        super();
